...
class App(ctk.CTk):
    def __init__(self):
        ...
        img1 = Image.open(folder_path + "info.png")
        img1_ctk = CTkImage(img1)
        self.img_button = ctk.CTkButton(master=self.head_frame, text="", image=img1_ctk, command=self.open_image_window,
                                         width=40, height=40)
        self.img_button.pack(pady=10, padx=10, anchor="nw", side="right")
        ...
        img_ctk = CTkImage(img_resized)

        self.img_label_ctk = ctk.CTkLabel(master=self.frame2, text="", image=img_ctk)
        self.img_label_ctk.pack(pady=1, padx=10)
    ...
    def upload_image(self):
        ...
        self.img_label_ctk.configure(image="")
        img = Image.open(filename)
        img_resized = img.resize((int(256 / img.height * img.width), 256))
        img_ctk = CTkImage(img_resized)
        self.img_label_ctk.configure(image=img_ctk)
        self.img_label_ctk.image = img_ctk
